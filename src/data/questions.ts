...
export const ALL_QUESTIONS: Question[] = [
  ...
  // ===== HELLO WORLD: write the code yourself =====
  {lang:"Java",level:1,q:"Write the line of code that prints \"Hello, World!\" to the console in Java.",code:null,type:"scratch",options:[],answer:0,
    requirements:["Use System.out.println","Print exactly: Hello, World!","End with a semicolon"],
    mustMatch:["System\\.out\\.println\\s*\\(\\s*[\"']Hello,\\s*World!?[\"']\\s*\\)\\s*;"],
    solution:'System.out.println("Hello, World!");',
    hint:"`System.out.println( ... );` — pass the string in quotes.",
    explain:"`System.out.println` writes to standard output and appends a newline."},
  {lang:"Python",level:1,q:"Write the line of code that prints \"Hello, World!\" in Python.",code:null,type:"scratch",options:[],answer:0,
    requirements:["Use the print function","Print exactly: Hello, World!"],
    mustMatch:["print\\s*\\(\\s*[\"']Hello,\\s*World!?[\"']\\s*\\)"],
    solution:'print("Hello, World!")',
    hint:"`print(...)` — string goes inside the parentheses.",
    explain:"`print()` writes its arguments to stdout followed by a newline."},
  {lang:"JavaScript",level:1,q:"Write the line of code that logs \"Hello, World!\" to the console in JavaScript.",code:null,type:"scratch",options:[],answer:0,
    requirements:["Use console.log","Print exactly: Hello, World!"],
    mustMatch:["console\\.log\\s*\\(\\s*[\"'`]Hello,\\s*World!?[\"'`]\\s*\\)"],
    solution:'console.log("Hello, World!");',
    hint:"`console.log( ... )` — wrap the string in quotes or backticks.",
    explain:"`console.log` is the standard way to print to the JS console."},
  {lang:"C",level:1,q:"Write the C statement inside `main` that prints \"Hello, World!\" followed by a newline.",code:null,type:"scratch",options:[],answer:0,
    requirements:["Use printf","Include \\n for newline","End with semicolon"],
    mustMatch:["printf\\s*\\(\\s*[\"']Hello,\\s*World!?\\\\n[\"']\\s*\\)\\s*;"],
    solution:'printf("Hello, World!\\n");',
    hint:"`printf(\"...\\n\");` — don't forget the `\\n`.",
    explain:"`printf` from `<stdio.h>` writes formatted output. `\\n` adds the newline."},
  {lang:"C++",level:1,q:"Write the C++ statement that prints \"Hello, World!\" with a newline using `std::cout`.",code:null,type:"scratch",options:[],answer:0,
    requirements:["Use std::cout (or cout)","Use << operator","Add std::endl or \\n"],
    mustMatch:["(std::)?cout\\s*<<\\s*[\"']Hello,\\s*World!?[\"']\\s*<<\\s*(std::)?endl|(std::)?cout\\s*<<\\s*[\"']Hello,\\s*World!?\\\\n[\"']"],
    solution:'std::cout << "Hello, World!" << std::endl;',
    hint:"`cout << \"...\" << endl;` — chain with `<<`.",
    explain:"`std::cout` writes to stdout via the stream insertion operator `<<`."},
  {lang:"C#",level:1,q:"Write the C# statement that prints \"Hello, World!\" to the console.",code:null,type:"scratch",options:[],answer:0,
    requirements:["Use Console.WriteLine","End with semicolon"],
    mustMatch:["Console\\.WriteLine\\s*\\(\\s*[\"']Hello,\\s*World!?[\"']\\s*\\)\\s*;"],
    solution:'Console.WriteLine("Hello, World!");',
    hint:"`Console.WriteLine( ... );`",
    explain:"`Console.WriteLine` writes a line to standard output in C#."},
  {lang:"Go",level:1,q:"Write the Go statement that prints \"Hello, World!\" with a newline using the `fmt` package.",code:null,type:"scratch",options:[],answer:0,
    requirements:["Use fmt.Println or fmt.Printf"],
    mustMatch:["fmt\\.(Println|Printf)\\s*\\(\\s*[\"`]Hello,\\s*World!?(\\\\n)?[\"`]\\s*\\)"],
    solution:'fmt.Println("Hello, World!")',
    hint:"`fmt.Println(\"...\")` adds a newline automatically.",
    explain:"`fmt.Println` from the `fmt` package prints with a trailing newline."},
  {lang:"Rust",level:1,q:"Write the Rust statement that prints \"Hello, World!\" with a newline.",code:null,type:"scratch",options:[],answer:0,
    requirements:["Use the println! macro","End with semicolon"],
    mustMatch:["println!\\s*\\(\\s*[\"']Hello,\\s*World!?[\"']\\s*\\)\\s*;"],
    solution:'println!("Hello, World!");',
    hint:"`println!( ... );` — note the `!`, it's a macro.",
    explain:"`println!` is a macro (note the `!`) that prints a line to stdout."},
  {lang:"PHP",level:1,q:"Write the PHP statement that outputs \"Hello, World!\" using `echo`.",code:null,type:"scratch",options:[],answer:0,
    requirements:["Use echo","End with semicolon"],
    mustMatch:["echo\\s+[\"']Hello,\\s*World!?[\"']\\s*;"],
    solution:'echo "Hello, World!";',
    hint:"`echo \"...\";`",
    explain:"`echo` outputs one or more strings in PHP."},
  {lang:"Bash",level:1,q:"Write the Bash command that prints \"Hello, World!\" to the terminal.",code:null,type:"scratch",options:[],answer:0,
    requirements:["Use echo","Print exactly: Hello, World!"],
    mustMatch:["echo\\s+[\"']?Hello,\\s*World!?[\"']?"],
    solution:'echo "Hello, World!"',
    hint:"`echo` followed by your text.",
    explain:"`echo` writes its arguments to stdout."},
  {lang:"Kotlin",level:1,q:"Write the Kotlin statement that prints \"Hello, World!\" to the console.",code:null,type:"scratch",options:[],answer:0,
    requirements:["Use println"],
    mustMatch:["println\\s*\\(\\s*[\"']Hello,\\s*World!?[\"']\\s*\\)"],
    solution:'println("Hello, World!")',
    hint:"`println( ... )` — no `System.out` needed in Kotlin.",
    explain:"Kotlin exposes `println` as a top-level function."},
  {lang:"Swift",level:1,q:"Write the Swift statement that prints \"Hello, World!\" to the console.",code:null,type:"scratch",options:[],answer:0,
    requirements:["Use print"],
    mustMatch:["print\\s*\\(\\s*[\"']Hello,\\s*World!?[\"']\\s*\\)"],
    solution:'print("Hello, World!")',
    hint:"`print( ... )`",
    explain:"`print` in Swift writes to standard output and appends a newline."},
  {lang:"TypeScript",level:1,q:"Write the TypeScript statement that logs \"Hello, World!\" to the console.",code:null,type:"scratch",options:[],answer:0,
    requirements:["Use console.log"],
    mustMatch:["console\\.log\\s*\\(\\s*[\"'`]Hello,\\s*World!?[\"'`]\\s*\\)"],
    solution:'console.log("Hello, World!");',
    hint:"Same as JavaScript.",
    explain:"TypeScript shares the `console.log` API with JavaScript."},
  {lang:"Python",level:2,q:"Write a Python function `greet(name)` that returns the string \"Hello, <name>!\".",code:null,type:"scratch",options:[],answer:0,
    requirements:["Function named `greet`","Takes one parameter `name`","Returns the greeting string"],
    mustMatch:["def\\s+greet\\s*\\(\\s*name\\s*\\)\\s*:","return\\s+.*(f[\"']Hello,?\\s*\\{name\\}!?[\"']|[\"']Hello,?\\s*[\"']\\s*\\+\\s*name|[\"']Hello,?\\s*%s!?[\"']\\s*%\\s*name|[\"']Hello,?\\s*\\{\\}!?[\"']\\.format\\s*\\(\\s*name)"],
    solution:'def greet(name):\n    return f"Hello, {name}!"',
    hint:"Use an f-string: `f\"Hello, {name}!\"`",
    explain:"f-strings interpolate variables directly into the string."},
  {lang:"JavaScript",level:2,q:"Write a function `square(n)` that returns n squared.",code:null,type:"scratch",options:[],answer:0,
    requirements:["Function named `square`","Returns n * n (or n ** 2)"],
    mustMatch:["function\\s+square\\s*\\(\\s*n\\s*\\)|square\\s*=\\s*\\(?\\s*n\\s*\\)?\\s*=>","return\\s+.*(n\\s*\\*\\s*n|n\\s*\\*\\*\\s*2|Math\\.pow\\s*\\(\\s*n\\s*,\\s*2)"],
    solution:"function square(n) {\n  return n * n;\n}",
    hint:"`return n * n` (or `n ** 2`).",
    explain:"Multiplying `n` by itself, or using `n ** 2`, both produce the square."},
  {lang:"Python",level:2,q:"Write a Python function `is_palindrome(s)` that returns True if `s` reads the same forwards and backwards.",code:null,type:"scratch",options:[],answer:0,
    requirements:["Function named `is_palindrome`","Compare s to its reverse","Return a boolean"],
    mustMatch:["def\\s+is_palindrome\\s*\\(\\s*s\\s*\\)\\s*:","return\\s+.*s\\s*==\\s*s\\s*\\[\\s*::\\s*-\\s*1\\s*\\]"],
    solution:"def is_palindrome(s):\n    return s == s[::-1]",
    hint:"`s[::-1]` reverses a string. Compare it to `s`.",
    explain:"Slice with step -1 reverses the string; equality check is the palindrome test."},
  {lang:"SQL",level:2,q:"Write a SQL query that selects all columns from the `users` table where `age` is greater than 18.",code:null,type:"scratch",options:[],answer:0,
    requirements:["Use SELECT *","FROM users","WHERE age > 18"],
    mustMatch:["SELECT\\s+\\*\\s+FROM\\s+users\\s+WHERE\\s+age\\s*>\\s*18"],
    solution:"SELECT * FROM users WHERE age > 18;",
    hint:"`SELECT * FROM <table> WHERE <condition>;`",
    explain:"`*` selects all columns; `WHERE` filters rows by the condition."},
